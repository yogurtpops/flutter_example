...
class NestedListviewDemo_ extends StatefulWidget {
  NestedListviewDemo_({Key key, this.title}) : super(key: key);
  final String title;
...
class NestedListviewDemoState extends State<NestedListviewDemo_> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Bad Nested Listview Example"),
        ),
        body: ListView(
